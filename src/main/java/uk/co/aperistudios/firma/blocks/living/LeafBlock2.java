...
public class LeafBlock2 extends BaseBlock {
	...
	private void checkForTree(World worldIn, BlockPos pos, IBlockState state) {
		WoodEnum2 woodType = Util.getWoodEnum2(state);
	...
	public boolean checkNeighbours(World worldIn, BlockPos pos, WoodEnum2 type, ArrayList<BlockPos> checkedLocations, ArrayList<BlockPos> leafLocations) {
