...
public class FirmaGenRavine extends MapGenBase {
	...
	protected void addTunnel(long p_180707_1_, int p_180707_3_, int p_180707_4_, ChunkPrimer p_180707_5_, double p_180707_6_, double p_180707_8_,
			double p_180707_10_, float p_180707_12_, float p_180707_13_, float p_180707_14_, int p_180707_15_, int p_180707_16_, double p_180707_17_) {
	...
	private static boolean isTopBlock(ChunkPrimer data, int x, int y, int z, int chunkX, int chunkZ) {
		return false;
		// net.minecraft.world.biome.Biome biome = world.getBiome(new BlockPos(x
		// + chunkX * 16, 0, z + chunkZ * 16));
		// IBlockState state = data.getBlockState(x, y, z);
		// return (isExceptionBiome(biome) ? Util.isGrass(state.getBlock()) :
		// state.getBlock() == biome.topBlock);
	}
