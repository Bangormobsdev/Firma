...
public class FirmaGenLayerBiome extends FirmaGenLayer {
	...
	private FirmaBiome[] allowedBiomes = new FirmaBiome[] { FirmaBiome.PLAINS, FirmaBiome.FOREST, FirmaBiome.HILLS, FirmaBiome.EXHILLS, FirmaBiome.LAKE,
			FirmaBiome.SWAMP };
	...
	/**
	 * Takes Continent data (only 0's and 1's) and for anything not ocean it
	 * throws any of the allowed biomes back. Can't help but wonder if I could
	 * do better than "Any of allowed" and possibly have hills mostly in-land
	 * etc. Will have to see
	 */
	@Override
